...
**Circuited plan — eight homeruns fanning back to the distribution panel:**
...
- **[Branch Circuits & Panel Schedule](CEC_Panel_Schedule.md)** — the panel's directory:
  every circuit with its breaker, conductor, protection (GFCI/AFCI), leg, and load. Also
  explains what is required by code versus a design choice, plus a plain-language legend
  of every term.
